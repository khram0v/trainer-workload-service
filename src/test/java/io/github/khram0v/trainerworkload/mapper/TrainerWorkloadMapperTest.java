...
class TrainerWorkloadMapperTest {
    ...
    void toSummaryResponse_mapsFields_andSortsYearsAndMonths() {
        ...
        WorkloadYear year2025 = new WorkloadYear(2025);
        WorkloadMonth jan2025 = new WorkloadMonth(1);
        jan2025.setTrainingSummaryDuration(30);
        year2025.getMonths().add(jan2025);

        WorkloadYear year2024 = new WorkloadYear(2024);
        WorkloadMonth june2024 = new WorkloadMonth(6);
        june2024.setTrainingSummaryDuration(60);
        WorkloadMonth march2024 = new WorkloadMonth(3);
